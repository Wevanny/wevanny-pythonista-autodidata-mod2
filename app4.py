...
# Através da criação de strings dinâmicos e os métodos de um string que acabou de aprender, use como base as 
# variáveis a seguir para criar a seguinte frase: print('É melhor FEITO que PERFEITO')
